...
function traverse(F) {
    return function (ta, f) { return F.map(f(ta.snd), function (b) { return new Tuple(ta.fst, b); }); };
}
/** @instance */
exports.tuple = {
    URI: exports.URI,
